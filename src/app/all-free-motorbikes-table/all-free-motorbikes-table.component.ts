...
@Component({
  selector: 'app-all-free-motorbikes-table',
  templateUrl: './all-free-motorbikes-table.component.html',
  styleUrls: ['./all-free-motorbikes-table.component.css']
})
export class AllFreeMotorbikesTableComponent implements OnInit, AfterViewInit {
 ...
 getServiceData() {
   this.GetAllVehiclesService.getAllFreeMotorbikes().subscribe(
     data => {
